package com.co.technicaltest.transaction_service.infrastructure.shared.enums;

/**
 * Enum for messages global errors.
 *
...
public enum ExceptionMessage {
    ...
    INCORRECT_TRANSACTION_STATUS("El tipo de tarnsacion suministrado no es valido, el valor ingresado fue: %s"),
    ...
    CONTRAINS_VALIDATION("Nombre de usuario ya se encuentra registrado en sistemas, intente con otro!"),
